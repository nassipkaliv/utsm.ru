...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".HeroSlider__content .swiper", {
  slidesPerView: 1,
  speed: 500,
  loop: true,
  spaceBetween: 30,
  ...
  navigation: {
    nextEl: ".HeroSlider__arrow.__next",
    prevEl: ".HeroSlider__arrow.__prev"
  },
  autoplay: {
    delay: 3500
  }
...
const swiper2 = new Swiper('.ut-IntroSwiper', { 
  effect: 'fade',
  ...
  loop: true,
  pagination: {
      el: '.ut-IntroSlider__pagination',
      clickable: true
  },
  navigation: {
      nextEl: '.ut-IntroSlider__arrow.__next', 
      prevEl: '.ut-IntroSlider__arrow.__prev'
  }
});
